...
public class ZipkinCassandraProperties implements Serializable {
    private static final Logger LOG = LoggerFactory.getLogger(ZipkinCassandraProperties.class);
    ...
    public CassandraStorage.Builder toBulider() {
