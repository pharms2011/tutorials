...
//
//import com.inertia.properties.CassandraProperties;
...
//
//    @Bean
//    StorageComponent storage(CassandraProperties properties,
//                             @Value("${zipkin.storage.strict-trace-id:true}") boolean strictTraceId,
//                             ObjectProvider<CassandraStorage.SessionFactory> tracingSessionFactory) {
//        LOG.info("Setting Cassandra Connection Factory parameters "+tracingSessionFactory.getIfAvailable());
